...
/***************************************************************************/	
	...
	function themify_header_slider($data=array()){
		...
		$output .= '</div>
					...
					<p>
						...
						for ( $x = 1; $x <= 7; $x ++ ) {
							$output .= '<option value="' . $x . '"' . selected( themify_get( 'setting-header_slider_visible' ), $x, false ) . '>' . $x . '</option>';
						}
	...
	function themify_header_slider_action($data=array()){
		$wrap = 'false';
		if ( 'yes' == themify_get( 'setting-header_slider_wrap' ) ) {
			$wrap = 'true';
		}
	...
	function themify_footer_slider_action($data=array()){
		$wrap = 'false';
		if ( 'yes' == themify_get( 'setting-footer_slider_wrap' ) ) {
			$wrap = 'true';
		}
