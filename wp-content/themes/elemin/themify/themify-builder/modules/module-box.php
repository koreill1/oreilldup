...
Themify_Builder_Model::register_module( 'TB_Box_Module', 
	apply_filters( 'themify_builder_module_box', array(
		...
		'styling_selector' => array(
			'.module-box' => array(
				'font_family', 'font_size', 'line_height', 'text_align', 'margin'
			),
			'.module-box .module-box-content' => array(
				'background_image', 'background_color', 'color', 'padding', 'border_top', 'border_right', 'border_bottom', 'border_left'
			),
			'.module-box .module-box-content h1' => array( 'color' ), '.module-box .module-box-content h2' => array( 'color' ), '.module-box .module-box-content h3' => array( 'color' ), '.module-box .module-box-content h4' => array( 'color' ), '.module-box .module-box-content h5' => array( 'color' ), '.module-box .module-box-content h6' => array( 'color' ),
