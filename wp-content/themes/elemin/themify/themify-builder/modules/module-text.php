...
Themify_Builder_Model::register_module( 'TB_Text_Module', 
	apply_filters( 'themify_builder_module_text', array(
		...
		'styling_selector' => array(
			...
			'.module-text h1' => array( 'color' ), '.module-text h2' => array( 'color' ), '.module-text h3:not(.module-title)' => array( 'color' ), '.module-text h4' => array( 'color' ), '.module-text h5' => array( 'color' ), '.module-text h6' => array( 'color' ),
